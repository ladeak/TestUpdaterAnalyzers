...
namespace TestHelper
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        private static readonly MetadataReference xUnitAnalysisReference = MetadataReference.CreateFromFile(typeof(FactAttribute).Assembly.Location);
        private static readonly MetadataReference xUnitAssertAnalysisReference = MetadataReference.CreateFromFile(typeof(Assert).Assembly.Location);
        private static readonly MetadataReference RhinoAnalysisReference = MetadataReference.CreateFromFile(typeof(MockRepository).Assembly.Location);
        private static readonly MetadataReference BusinessLogicReference = MetadataReference.CreateFromFile(typeof(IValidator).Assembly.Location);
        ...
        protected static Diagnostic[] GetSortedDiagnosticsFromDocuments(DiagnosticAnalyzer analyzer, Document[] documents)
        {
            ...
            {
                var a = project.GetCompilationAsync().Result;
    ...
    {
        public static Solution AddRuntimeLibrary(this Solution solution, ProjectId projectId, string fileName)
        {
